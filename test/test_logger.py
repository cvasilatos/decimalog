"""Tests for decimalog logger module."""
...
from decimalog import CustomLogger, JsonFormatter, LogFormatter
...
class TestLogFormatter:
    ...
    def test_format_debug_contains_blue(self) -> None:
        ...
        record = logging.LogRecord(
            name="test", level=logging.DEBUG, pathname="", lineno=0, msg="debug msg", args=(), exc_info=None
        )
    ...
    def test_format_error_contains_red(self) -> None:
        ...
        formatter = LogFormatter()
        record = logging.LogRecord(
            name="test", level=logging.ERROR, pathname="", lineno=0, msg="err msg", args=(), exc_info=None
        )
        result = formatter.format(record)
    ...
    def test_format_critical_contains_bold_red(self) -> None:
        ...
        formatter = LogFormatter()
        record = logging.LogRecord(
            name="test", level=logging.CRITICAL, pathname="", lineno=0, msg="crit msg", args=(), exc_info=None
        )
        result = formatter.format(record)
    ...
    def test_format_trace_contains_cyan(self) -> None:
        ...
        formatter = LogFormatter()
        record = logging.LogRecord(
            name="test", level=5, pathname="", lineno=0, msg="trace msg", args=(), exc_info=None
        )
        result = formatter.format(record)
    ...
    def test_format_truncates_long_name(self) -> None:
        ...
        record = logging.LogRecord(
            name=long_name, level=logging.INFO, pathname="", lineno=0, msg="msg", args=(), exc_info=None
        )
        formatter.format(record)
        assert len(record.name) == 25
        assert record.name == long_name[-25:]
    ...
    def test_format_short_name_unchanged(self) -> None:
        ...
        short_name = "mylogger"
        record = logging.LogRecord(
            name=short_name, level=logging.INFO, pathname="", lineno=0, msg="msg", args=(), exc_info=None
        )
        formatter.format(record)
...
class TestJsonFormatter:
    ...
    def test_format_returns_valid_json(self) -> None:
        ...
        record = logging.LogRecord(
            name="testlogger", level=logging.INFO, pathname="", lineno=0, msg="hello", args=(), exc_info=None
        )
        result = formatter.format(record)
    ...
    def test_format_contains_required_fields(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="myapp", level=logging.WARNING, pathname="", lineno=0, msg="something happened", args=(), exc_info=None
        )
    ...
    def test_format_level_name(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="test", level=logging.ERROR, pathname="", lineno=0, msg="oops", args=(), exc_info=None
        )
        parsed = json.loads(formatter.format(record))
    ...
    def test_format_message_content(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="test", level=logging.INFO, pathname="", lineno=0, msg="specific message text", args=(), exc_info=None
        )
        parsed = json.loads(formatter.format(record))
    ...
    def test_format_name_field(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="myservice", level=logging.DEBUG, pathname="", lineno=0, msg="msg", args=(), exc_info=None
        )
        parsed = json.loads(formatter.format(record))
    ...
    def test_format_extra_data_included(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="test", level=logging.INFO, pathname="", lineno=0, msg="msg with extra", args=(), exc_info=None
        )
        record.extra_data = {"user_id": 42, "action": "login"}  # type: ignore[attr-defined]
        parsed = json.loads(formatter.format(record))
    ...
    def test_format_no_extra_data_omits_extra_field(self) -> None:
        ...
        formatter = JsonFormatter()
        record = logging.LogRecord(
            name="test", level=logging.INFO, pathname="", lineno=0, msg="plain msg", args=(), exc_info=None
        )
        parsed = json.loads(formatter.format(record))
...
class TestCustomLogger:
    ...
    def test_setup_logging_creates_log_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            CustomLogger.setup_logging(tmpdir, "testapp", "DEBUG")
            log_dir = Path(tmpdir)
    ...
    def test_setup_logging_creates_directory_if_missing(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            CustomLogger.setup_logging(nested, "app", "INFO")
    ...
    def test_setup_logging_sets_logger_class(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            CustomLogger.setup_logging(tmpdir, "cls_test", "DEBUG")
    ...
    def test_setup_logging_jsonl_records_valid_json(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            CustomLogger.setup_logging(tmpdir, "jsontest", "DEBUG")
